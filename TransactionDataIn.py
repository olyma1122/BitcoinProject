...
if __name__ == "__main__":
    ...
    path = "Data/set/new*.csv" #檔案路徑
    original_df = sqlContext.read.format("csv").options(header="true", inferSchema="true").load(path)
    df = original_df.toDF("timestamp", "transaction_id", "transactions_input_pubkey_base58", "transactions_input_pubkey_base58_error")
    ...
    df.write.parquet("Data/Nov2017Apr2018_part3/data.parquet")
